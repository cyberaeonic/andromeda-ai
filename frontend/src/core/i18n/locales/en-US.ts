...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to Andromeda AI — your autonomous enterprise intelligence platform. Ask strategic questions, upload datasets, schedule market scans, and let AI agents handle the heavy lifting across finance, operations, and growth.",

    createYourOwnSkill: "Create a Business Skill",
    createYourOwnSkillDescription:
      "Build custom business skills to automate workflows across your organization. From financial modeling to competitor analysis, Andromeda AI adapts to your enterprise needs.",
  },
  ...
  scheduledTasks: {
    ...
    recipes: {
      label: "Quick create",
      trending: {
        title: "Market Trends Daily",
        desc: "Scan today's top business & market trends",
      },
      news: {
        title: "Business News Digest",
        desc: "Collect and summarize today's top business news",
      },
      issues: {
        title: "Pipeline Review",
        desc: "Analyze open action items and flag priorities",
      },
      weekly: {
        title: "Weekly Business Review",
        desc: "Revenue vs target, priorities for next week",
      },
    },
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Andromeda AI is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Andromeda AI could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "Andromeda AI official website",
    githubTooltip: "Andromeda AI on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "Andromeda AI on GitHub",
    reportIssue: "Report an issue",
    contactUs: "Contact us",
    about: "About Andromeda AI",
    logout: "Log out",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your Andromeda AI bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your Andromeda AI bot.",
      feishu: "Feishu and Lark messages through your Andromeda AI app.",
      dingtalk: "DingTalk Stream Push messages through your Andromeda AI bot.",
      wechat: "WeChat iLink messages through your Andromeda AI bot.",
      wecom: "WeCom messages through your Andromeda AI AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Andromeda AI",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Andromeda AI faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Andromeda AI looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "Andromeda AI automatically learns from your conversations in the background. These memories help Andromeda AI understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to Andromeda AI from outside the browser.",
      disabled:
    ...
    skills: {
      ...
      description:
        "Manage the configuration and enabled status of your business skills.",
      createSkill: "Create skill",
      emptyTitle: "No agent skill yet",
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Andromeda AI.",
    ...
    notification: {
      title: "Notification",
      description:
        "Andromeda AI only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "Andromeda AI",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so Andromeda AI cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "Andromeda AI needs an administrator account before new regular accounts can be created.",

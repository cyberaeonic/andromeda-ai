  ...
  return (
    ...
    >
      ...
      <div className="container-md relative z-10 mx-auto flex min-h-[92svh] flex-col items-center justify-center px-4 pt-20 pb-14">
        <h1 className="andromeda-text-gradient text-center text-5xl leading-tight font-bold break-words md:text-6xl">
          Andromeda Galaxy
        </h1>
        ...
        <p className="text-muted-foreground mt-8 max-w-4xl text-center text-base leading-7 text-shadow-sm sm:text-xl md:text-2xl">
          A galaxy of intelligent agents that research, code, and create.
          Powered by sandboxes, memories, skills, and subagents — your cosmic
          command center for tasks that span minutes to hours.
        </p>
        <Link href="/workspace">
      ...
      <AnimatePresence mode="popLayout">
        ...
        >
          <AuroraText
            ...
            speed={3}
            colors={["#00CED1", "#8B5CF6", "#06B6D4", "#7C3AED"]}
          >
            {words[index]}
          </AuroraText>
        </motion.div>

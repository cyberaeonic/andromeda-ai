...
class DiscordChannel(Channel):
    ...
    def __init__(self, bus: MessageBus, config: dict[str, Any]) -> None:
        ...
        # conversations to Andromeda AI thread IDs — a different concern.
        ...
        if store is not None:
            ...
            self._thread_store_path = Path.home() / ".andromeda-ai" / "channels" / "discord_threads.json"
    ...
    async def _bind_connection_from_connect_code(self, message, code: str) -> bool:
        ...
        await self._send_connection_reply(message, "Discord connected to Andromeda AI.")
        return True

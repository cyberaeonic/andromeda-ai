...
async def _ensure_admin_user(app: FastAPI) -> None:
    ...
    "no-auth → with-auth" upgrade path: users who ran Andromeda AI without
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="Andromeda AI API Gateway",
        description="""
## Andromeda AI API Gateway

API Gateway for Andromeda AI - A LangGraph-based AI agent backend with sandbox execution capabilities.
...
This gateway provides runtime endpoints for agent runs plus custom endpoints for models, MCP configuration, skills, and artifacts.
        ...
        openapi_tags=[
            ...
            {
                "name": "threads",
                "description": "Manage Andromeda AI thread-local filesystem data",
            },
            {
                "name": "agents",
    ...
    async def health_check() -> dict[str, str]:
        ...
        """
        return {"status": "healthy", "service": "andromeda-ai-gateway"}
